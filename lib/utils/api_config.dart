...
/// API Configuration for all platforms and environments
class ApiConfig {
  // ═══════════════════════════════════════════════════════════════
  // 🌐 SERVER URLS
  // ═══════════════════════════════════════════════════════════════
  ...
  static String get baseUrl {
    ...
    switch (_currentMode) {
      ...
      case DevMode.localhost:
        // Auto-detect platform for localhost
        if (Platform.isAndroid) {
          return androidEmulatorUrl; // Android Emulator uses 10.0.2.2
        } else if (Platform.isIOS) {
          return localhostUrl; // iOS Simulator uses localhost
        }
        return localhostUrl;
        
      case DevMode.network:
        return localNetworkUrl; // For physical devices on same WiFi
    }
  }
  
  /// Socket URL (same as base URL for WebRTC)
  ...
  static String getCancelAppointmentUrl(String id) => '$appointments/$id/status';
  ...
  static String getDoctorReviewsUrl(String doctorId) => '$doctorReviews/$doctorId';
  static String getMarkAsReadUrl(String notificationId) => '$markAsRead/$notificationId/read';
