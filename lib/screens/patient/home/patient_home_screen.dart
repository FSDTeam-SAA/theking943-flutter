...
class _PatientHomeScreenState extends State<PatientHomeScreen> {
  ...
  void _addDoctorMarkers() {
    try {
      ...
      for (int i = 0; i < doctors.length; i++) {
        ...
        // Calculate distance
        double distanceKm = _calculateDistanceInKm(_currentPosition, doctorLocation);
          ...
          markers.add(
            Marker(
              ...
              infoWindow: InfoWindow(
                ...
                snippet: '${doctor.specialty} - ${distanceKm.toStringAsFixed(1)} km away',
              ),
  ...
  void _showDoctorRoute(String doctorId, LatLng doctorLocation, double distance) {
    setState(() {
    ...
    final doctor = context.read<DoctorProvider>().nearbyDoctors
      .firstWhere((d) => d.id == doctorId);
                  ...
                  children: [
                    ...
                    Consumer<DoctorProvider>(
                      builder: (context, doctorProvider, child) {
                        ...
                        final nearbyDoctors = doctorProvider.nearbyDoctors.where((doctor) {
                          if (doctor.latitude != null && doctor.longitude != null) {
                            final doctorLocation = LatLng(doctor.latitude!, doctor.longitude!);
                            final distance = _calculateDistanceInKm(_currentPosition, doctorLocation);
                            return distance <= 20;
                          }
  ...
  Widget _buildCustomDoctorCard(Doctor doctor) {
    ...
    if (doctor.latitude != null && doctor.longitude != null) {
      final doctorLocation = LatLng(doctor.latitude!, doctor.longitude!);
      final distanceKm = _calculateDistanceInKm(_currentPosition, doctorLocation);
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Expanded(
                          child: doctor.latitude != null && doctor.longitude != null
                              ? Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Row(
                                    ...
                                    if (doctor.location.isNotEmpty && doctor.location != 'N/A')
                                      Text(
                                        doctor.location,
                                        style: const TextStyle(
                                          color: Colors.grey,
