...
class _DoctorReelsScreenState extends State<DoctorReelsScreen> {
  final List<Map<String, dynamic>> reelsList = [
    {
      'thumbnail': 'assets/images/doctor1.png',
      'doctorName': 'Dr. Jaynor Abedin',
      'specialty': 'Pediatric Surgery',
    },
    {
      'thumbnail': 'assets/images/doctor2.png',
      'doctorName': 'Dr. Sarah Johnson',
      'specialty': 'Cardiologist',
    },
    {
      'thumbnail': 'assets/images/doctor3.png',
      'doctorName': 'Dr. Michael Chen',
      'specialty': 'Dermatologist',
    },
    {
      'thumbnail': 'assets/images/doctor4.png',
      'doctorName': 'Dr. Emily White',
      'specialty': 'Neurologist',
    },
    {
      'thumbnail': 'assets/images/doctor5.png',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PageView.builder(
        ...
        itemBuilder: (context, index) {
          return _buildReelPage(widget.reelsList[index]);
        },
      ),
    );
  }
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/reelsviewdoctor.png'),
              fit: BoxFit.cover,
            ),
          ),
          child: Container(
