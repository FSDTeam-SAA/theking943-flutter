...
import 'package:docmobi/screens/onboarding/onboarding_3_screen.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'Live Consultation with Expert Doctors',
                style: TextStyle(
                  fontSize: 26,
              ...
              Text(
                'Connect with expert doctors and get instant healthcare advice',
                style: TextStyle(
                  fontSize: 16,
